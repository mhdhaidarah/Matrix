...
#   - Generates a self-signed TLS cert and configures nginx so that
#     Synapse-Admin and the Matrix API live on the SAME origin (no CORS pain)
...
======================================================================
  ...
  Connect a client (Element etc.) to: https://${SERVER_NAME}
